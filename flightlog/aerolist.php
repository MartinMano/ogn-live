...
$aero = array (
	...
	'LZMT'=> array('MARTIN',"l.rec='LZMT' AND l.alt < 1120 AND (l.lat BETWEEN 49.05999 AND 49.07065 ) AND (l.lon BETWEEN 18.94687 AND 18.95504)",420,''),
	'LZRU'=> array('RUZOMBEROK',"l.rec='LZRU' AND l.alt < 1193 AND (l.lat BETWEEN 49.07954 AND 49.08983 ) AND (l.lon BETWEEN 19.35805 AND 19.37982)",493,''),
	);
